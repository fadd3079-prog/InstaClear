...
CREATE POLICY "Allow anonymous select audit_sessions"
    ON audit_sessions FOR SELECT TO anon USING (true);

CREATE POLICY "Allow anonymous insert audit_sessions"
    ON audit_sessions FOR INSERT TO anon WITH CHECK (true);

CREATE POLICY "Allow anonymous update audit_sessions"
    ON audit_sessions FOR UPDATE TO anon USING (true) WITH CHECK (true);

CREATE POLICY "Allow anonymous select unfollow_targets"
    ON unfollow_targets FOR SELECT TO anon USING (true);

CREATE POLICY "Allow anonymous insert unfollow_targets"
    ON unfollow_targets FOR INSERT TO anon WITH CHECK (true);
